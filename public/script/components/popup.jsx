    ...
    render() { 
        ...
        return (<div className='main-Popup'>
                    ...
                    <div id="bottom-transactions-history-NFT" className='css-bottom-transaction'>
                        {/* <div role="tablist" aria-orientation="horizontal" className="chakra-tabs__tablist css-1uw5bnh">
                            <button type="button" id="tabs-18--tab-0" role="tab" tabIndex="0" ariaSelected="true" ariaControls="tabs-18--tabpanel-0" className="chakra-tabs__tab css-jykylc" dataIndex="0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" focusable="false" className="chakra-icon css-i1hv63" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button type="button" id="tabs-18--tab-1" role="tab" tabIndex="-1" ariaSelected="false" ariaControls="tabs-18--tabpanel-1" className="chakra-tabs__tab css-jykylc" dataIndex="1">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" focusable="false" className="chakra-icon css-i1hv63" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M480.07 96H160a160 160 0 1 0 114.24 272h91.52A160 160 0 1 0 480.07 96zM248 268a12 12 0 0 1-12 12h-52v52a12 12 0 0 1-12 12h-24a12 12 0 0 1-12-12v-52H84a12 12 0 0 1-12-12v-24a12 12 0 0 1 12-12h52v-52a12 12 0 0 1 12-12h24a12 12 0 0 1 12 12v52h52a12 12 0 0 1 12 12zm216 76a40 40 0 1 1 40-40 40 40 0 0 1-40 40zm64-96a40 40 0 1 1 40-40 40 40 0 0 1-40 40z"></path>
                                </svg>
                            </button>
                            <button type="button" id="tabs-18--tab-2" role="tab" tabIndex="-1" ariaSelected="false" ariaControls="tabs-18--tabpanel-2" className="chakra-tabs__tab css-1thn5bl" dataIndex="2">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" focusable="false" className="chakra-icon css-i1hv63" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M8.515 1.019A7 7 0 008 1V0a8 8 0 01.589.022l-.074.997zm2.004.45a7.003 7.003 0 00-.985-.299l.219-.976c.383.086.76.2 1.126.342l-.36.933zm1.37.71a7.01 7.01 0 00-.439-.27l.493-.87a8.025 8.025 0 01.979.654l-.615.789a6.996 6.996 0 00-.418-.302zm1.834 1.79a6.99 6.99 0 00-.653-.796l.724-.69c.27.285.52.59.747.91l-.818.576zm.744 1.352a7.08 7.08 0 00-.214-.468l.893-.45a7.976 7.976 0 01.45 1.088l-.95.313a7.023 7.023 0 00-.179-.483zm.53 2.507a6.991 6.991 0 00-.1-1.025l.985-.17c.067.386.106.778.116 1.17l-1 .025zm-.131 1.538c.033-.17.06-.339.081-.51l.993.123a7.957 7.957 0 01-.23 1.155l-.964-.267c.046-.165.086-.332.12-.501zm-.952 2.379c.184-.29.346-.594.486-.908l.914.405c-.16.36-.345.706-.555 1.038l-.845-.535zm-.964 1.205c.122-.122.239-.248.35-.378l.758.653a8.073 8.073 0 01-.401.432l-.707-.707z" clipRule="evenodd"></path>
                                    <path fill-rule="evenodd" d="M8 1a7 7 0 104.95 11.95l.707.707A8.001 8.001 0 118 0v1z" clipRule="evenodd"></path>
                                    <path fill-rule="evenodd" d="M7.5 3a.5.5 0 01.5.5v5.21l3.248 1.856a.5.5 0 01-.496.868l-3.5-2A.5.5 0 017 9V3.5a.5.5 0 01.5-.5z" clipRule="evenodd"></path>
                                </svg>
                            </button>
                        </div> */}
                    </div>
